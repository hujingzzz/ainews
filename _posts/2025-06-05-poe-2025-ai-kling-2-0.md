...
!" (https://assets-v2.circle.so/b39343gqllkhltljuj7rd8vbo2u)
...
!" (https://assets-v2.circle.so/hvjxyiiqran6yttp01www4ww56w) Since the beginning of 2025, front-line laboratories have been fast-tracking the products of their reasoning models. This has led to an increase in the number of models that are able to spend more time and computing capacity to solve complex tasks with greater precision and reliability. It is worth noting that during the reporting period, the share of all text messages sent to the Poe reasoning model increased from ~2% to ~10%, peaking at DeepSeek at the time of the virus.
The following is the share of information in the text subcategory for models that have the ability to reason.
(https://assets-v2.circle.so/74em8e0631zs526661vmqeugklcas)

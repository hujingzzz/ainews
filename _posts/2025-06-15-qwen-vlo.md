...
[] (https://assets-v2.circle.so/smpfv7qb8k4hlzrvypt3dadpsh2) These functions provide the model with the basic capability of “**Analysis of images as humans**” and can be used for downstream visual tasks.
...
(https://assets-v2.circle.so/l3mf78vo9ym09p7oyykpvkxrnsy) [] (https://assets-v2.circle.so/04lo5hf7vharv6pnxvvvv2s3pxu)
...
!" (https://assets-v2.circle.so/k3m0eo0jtvl99eh4kbizhoqng9)
...
!" (https://assets-v2.circle.so/qsh6qx0o3aj801ncb7ogy0dvey9)

# Key upgrades compared to the old version (VL Plus/ VL Max)
(https://assets-v2.circle.so/jq2tem8c12h623squfmimv6l064i) For more information: https://qwenm.github.io/zh/blog/qwen-vlo/

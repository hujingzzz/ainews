...
!" (https://assets-v2.circle.so/s68ux2ljzip97vf3bvp8j3c0c3) This dig is taking place at a time when Meta is facing a development dilemma for AI. Its latest open-source model, Llama 4, has been resoundingly flat, expressing intra-firm dissatisfaction with model performance and market competitiveness. In addition, Meta has in recent years experienced challenges of loss of staff and delayed release of open-source AI models, lagging behind competitors such as Google, OpenAI, and DeepSeek in China.

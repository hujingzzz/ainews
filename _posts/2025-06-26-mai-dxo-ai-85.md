...
Each “doctor” role [https://assets-v2.circle.so/1th4slfqozl2vvi3omkkw5fpvued] makes recommendations and discusses decisions based on his or her own responsibility. This method simulates how doctors collect evidence, raise new questions and give instructions for the examination, with limited information, through ** multiple rounds of decision-making**, until the diagnosis is finally confirmed.
...
!" (https://assets-v2.circle.so/z8d9n8i8n7zu529mwdewb6a4sx7)
...
(https://assets-v2.circle.so/wsnxmx39tqxrf36ciwua3oxjzv)

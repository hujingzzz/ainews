...
Microsoft has developed a system called **MAI-DxO**, which allows AI to conduct diagnostics step by step, as a true doctor does **, including questions, examinations, analyses, and final diagnosis of causes, rather than direct answers. It simulates multiple doctors working together, progressively reasoning and accurately diagnosing complex cases.
...
## What is the advantage of ## and doctors?[https://assets-v2.circle.so/xqmzylhwx3ldkzti19vf93yd7w] ## MAI-DxO Detailed Functions and Characteristics**: **The five virtual doctor role co-diagnosis (Panel of Virtual Doctors)** MAI-DxO is not a single AI model,** a system that coordinates multiple AI models** simulates collaboration between doctors, forming a virtual “doctor team”. This team has different roles, taking different roles: [https://assets-v2.circle.so/1th4slfqozl2vvv3mkw5pvued) each “doctor” role makes recommendations according to its own duties, and ultimately makes a decision.

- ** Three decision-making steps**: ** Question**: AI raises issues related to patients ' symptoms, history, etc.
...
#1. Multi-model teamwork (Orchestr)**
...
- These AI models, like doctors in different fields, “discussion of cases” can be reasoned and decided upon in different ways.[...] (https://assets-v2.circle.so/wsnxmx39tqxrf36ciwua3oxjzv) MAI-Dx Orchestrator can transform any language model into a virtual clinical team of experts: it can ask follow-up questions, arrange tests or diagnoses, then conduct cost tests and validate its own reasoning, and finally decide whether to proceed.
...
# ** MAI-DXO effects and performance** MAI-DXO shows very strong performances in a series of rigorous assessments, especially in complex diagnostic missions, as follows: **1. Performance in diagnostic accuracy**:
...
- MAI-DXO also upgraded all models' performance in the 304 cases![3] (https://assets-v2.circle.so/f6xlt5q00xyjvdo0u3oh8d0xt) **2. Performance in cost efficiency**:
...
- **The advantages of multiple models**: Through collaboration between different AI models, MAI-DxO can provide more comprehensive and accurate diagnostic results using the strengths of different models in ** complex diagnostic tasks**[!] (https://assets-v2.circle.so/4g69g045lia9oh5doe1mof59ku2e) By showing the accuracy and cost of different AI systems, the above figures help us to understand which systems (e.g. MAI-DxO) are accurate and cost-effective in their diagnosis, far beyond the performance of doctors and single AI models.
